            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {course.instructor && (
                <div className="flex items-center gap-3 pt-4">
                  <div className="relative h-12 w-12 rounded-full overflow-hidden bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white font-semibold">
